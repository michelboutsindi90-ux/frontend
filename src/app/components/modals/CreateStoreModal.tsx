        ...
        >
          <div className="p-6 bg-gradient-to-r from-[#FFF4BF]/80 via-white to-stone-50 border-b border-stone-100 relative shrink-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-extrabold text-[#171717] mt-0.5">Créer une nouvelle boutique</h2>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5 overflow-y-auto flex-1">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Plateau / Cocody, Abidjan"
                  value={address}
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="flex items-center gap-2 px-7 py-3 rounded-2xl bg-[#FFD43B] text-[#171717] font-black text-xs shadow-lg shadow-[#FFD43B]/30 hover:brightness-105 transition-all disabled:opacity-60"
              >
                {isSubmitting ? (
